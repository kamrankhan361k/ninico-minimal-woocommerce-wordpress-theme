            ...
            <div class="col-lg-<?php print esc_attr( $blog_column );?> blog-post-items">
            	<div class="postbox pr-20 pb-50">
					...
					<div class="result-bar page-header d-none">
						<h1 class="page-title"><?php esc_html_e( 'Search Results For:', 'ninico' );?> <?php print get_search_query();?></h1>
					</div>
					<?php
					...
					<div class="basic-pagination basic-pagination-2 mb-40">
						<?php ninico_pagination( '<i class="fas fa-angle-double-left"></i>', '<i class="fas fa-angle-double-right"></i>', '', [ 'class' => '' ] );?>
					</div>
					<?php
						else:
