                                ...
                                <div class="row p-relative align-items-end">
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6 d-none d-md-block">
                                        <div class="tpslidertwo__img p-relative text-end">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-01.png" alt="ninico_img">
                                            <div class="tpslidertwo__img-shape">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/fasion-tag-01.png" alt="tag">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="slider-top-padding pt-55">
                                <div class="row p-relative align-items-end">
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6 d-none d-md-block">
                                        <div class="tpslidertwo__img p-relative text-end">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-02.png" alt="ninico_img">
                                            <div class="tpslidertwo__img-shape">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/fasion-tag-01.png" alt="tag">
                                            </div>
                                        </div>
                        ...
                        <div class="container">
                            <div class="slider-top-padding pt-55">
                                <div class="row p-relative align-items-end">
                                    ...
                                    <div class="col-xl-7 col-lg-6 col-md-6 d-none d-md-block">
                                        <div class="tpslidertwo__img p-relative text-end">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/slider-03.png" alt="ninico_img">
                                            <div class="tpslidertwo__img-shape">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/slider/fasion-tag-01.png" alt="tag">
                                            </div>
                                        </div>
            ...
            <div class="row g-0">
                <div class="col-lg-3 col-md-3">
                    <div class="banneritem__thumb banner-animation text-center p-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/banner-2-01.jpg" alt="ninico_img">
                    ...
                    <div class="banneritem__thumb banner-animation text-center p-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/banner-2-02.jpg" alt="ninico_img">
                        <div class="banneritem__content">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="banneritem__thumb banner-animation text-center p-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/banner-2-03.jpg" alt="ninico_img">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="banneritem__thumb banner-animation text-center p-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/banner-2-04.jpg" alt="ninico_img">
                        <div class="banneritem__content">
                            <a href="shop-2.html"><i class="far fa-long-arrow-right"></i></a>
                            <p>13 Items</p>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-21.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-22.jpg" alt="product-thumb">
                                        </a>
                                ...
                                <div class="tpproduct__content-area">
                                    <h3 class="tpproduct__title mb-5"><a href="shop-details.html">Purab Enormous Miranda
                                            Bottle</a></h3>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-31.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-32.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-27.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-28.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-25.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-26.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-29.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-30.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                                ...
                                <div class="tpproduct__content-area">
                                    <h3 class="tpproduct__title mb-5"><a href="shop-details.html">CLCo. Incredible Paper
                                            Car</a></h3>
                                    <div class="tpproduct__priceinfo p-relative">
                                        <div class="tpproduct__ammount">
                                            <span>$31.00</span>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-33.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-34.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-23.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-24.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-35.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-36.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-37.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-38.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                        ...
                        <div class="col">
                            <div class="tpproduct tpproductitem mb-15 p-relative">
                                <div class="tpproduct__thumb">
                                    <div class="tpproduct__thumbitem p-relative">
                                        <a href="shop-details-2.html">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-39.jpg" alt="product-thumb">
                                            <img class="thumbitem-secondary"
                                                src="<?php echo get_template_directory_uri(); ?>/assets/img/product/home-two/product-40.jpg" alt="product-thumb">
                                        </a>
                                        <div class="tpproduct__thumb-bg">
                                            <div class="tpproductactionbg">
                                                <a href="cart.html"><i class="fal fa-shopping-basket"></i></a>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="exclusiveitem banner-animation p-relative mb-30">
                        <div class="exclusiveitem__thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/banner-offer-01.jpg" alt="ninico_img">
                        </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="exclusivearea banner-animation p-relative mb-30">
                        <div class="exclusivearea__thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/banner-offer-02.jpg" alt="ninico_img">
                        </div>
                    ...
                    <div class="blog-main-box">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="blogheader mb-20 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="tpallblog mb-20">
                                        <h4 class="blog-btn"><a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/">All Blog <i
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="blogitem mb-40">
                                    <div class="blogitem__thumb fix mb-20">
                                        <a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-01.jpg"
                                                alt="blog-bg"></a>
                                    </div>
                                    <div class="blogitem__content">
                                        ...
                                        <h4 class="blogitem__title"><a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/">Here is why you cannot
                                                miss EORS 15</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="blogitem mb-40">
                                    <div class="blogitem__thumb fix mb-20">
                                        <a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-02.jpg"
                                                alt="blog-bg"></a>
                                    </div>
                                    <div class="blogitem__content">
                                        <div class="blogitem__contetn-date mb-10">
                                        ...
                                        <h4 class="blogitem__title"><a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/">Myntra launches
                                                international brand DeFacto</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="blogitem mb-40">
                                    <div class="blogitem__thumb fix mb-20">
                                        <a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-03.jpg"
                                                alt="blog-bg"></a>
                                    </div>
                                    <div class="blogitem__content">
                                        <div class="blogitem__contetn-date mb-10">
                                        ...
                                        <h4 class="blogitem__title"><a href="https://weblearnbd.net/wp/ninico/can-my-premium-license-be-used-for-all-devices/">Ruskin Bond Shares His
                                                Life Experiences</a>
                                        </h4>
                                    </div>
                                </div>
                        ...
                        <div class="tpcta__input p-relative mb-10">
                            <form action="#">
                                ...
                                <div class="tpcta__btn banner-animation mt-10">
                                    <button>Subscribe Now <span><i class="far fa-long-arrow-right"></i></span></button>
                                </div>
                            </form>
                        </div>
            ...
            <div class="swiper-container brand-active">
                <div class="swiper-wrapper brand-items black-bg-brand">
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-01.png" alt="brand">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-02.png" alt="brand">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-03.png" alt="brand">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-04.png" alt="brand">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-05.png" alt="brand">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-06.png" alt="brand">
                    </div>
                    <div class="swiper-slide">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/brand/brand-04.png" alt="brand">
                    </div>
