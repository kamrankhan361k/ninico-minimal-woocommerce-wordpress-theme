                ...
                <div class="col-md-7">
                    <div class="tptrack__product">
                        <div class="tptrack__thumb">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/track-bg.jpg" alt="ninico_img">
                        </div>
                        <div class="tptrack__content grey-bg-3">
                            <div class="tptrack__item d-flex mb-20">
                                <div class="tptrack__item-icon">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon/track-1.png" alt="ninico_img">
                                </div>
