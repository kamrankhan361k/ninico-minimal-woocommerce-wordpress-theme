                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="tpabout__inner-thumb mb-40">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/about-img-1.jpg" alt="ninico_img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="tpabout__inner-thumb mb-40">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/about-img-2.jpg" alt="ninico_img">
                        </div>
                    </div>
                </div>
                <div class="tpabout__logo">
                    <a href="https://weblearnbd.net/wp/ninico/"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/about-img-3.png" alt="ninico_img"></a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12">
                    <div class="tpabout__inner-list mb-40">
                        <ul>
                            <li> <a href="#"><i class="fal fa-check"></i> Orders go right to your restaurant point of
                                    sale, KDS, and kitchen</a>
                            </li>
            ...
            <div class="swiper-container tp-team-active">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="tpteam__item p-relative mb-40">
                            <div class="tpteam__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/team-1.jpg" alt="ninico_img">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="tpteam__item p-relative mb-40">
                            <div class="tpteam__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/team-2.jpg" alt="ninico_img">
                            </div>
                            <div class="tpteam__content">
                    ...
                    <div class="swiper-slide">
                        <div class="tpteam__item p-relative mb-40">
                            <div class="tpteam__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/team-3.jpg" alt="ninico_img">
                            </div>
                            <div class="tpteam__content">
                    ...
                    <div class="swiper-slide">
                        <div class="tpteam__item p-relative mb-40">
                            <div class="tpteam__thumb">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/testimonial/team-4.jpg" alt="ninico_img">
                            </div>
                            <div class="tpteam__content">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="tpfeature__inner-thumb mb-70">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/about-banner-1.jpg" alt="ninico_img">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="tpabout__inner-title-area about-inner-content ml-50 mr-50 mb-70">
                        ...
                        <a class="tpteam__btn" href="https://weblearnbd.net/wp/ninico/contact/">Get In Touch</a>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="tpabout__inner-title-area about-inner-content mr-100 mb-70">
                        ...
                        <a class="tpteam__btn" href="https://weblearnbd.net/wp/ninico/contact/">Contact With Us</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="tpfeature__inner-thumb mb-70">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/banner/about-banner-2.jpg" alt="ninico_img">
                    </div>
                </div>
            </div>
        </div>
