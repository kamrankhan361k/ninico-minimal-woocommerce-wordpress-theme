...
if ( !class_exists( 'Ninico_Navwalker_Class' ) ) {
    /**
     * WP_Bootstrap_Navwalker class.
     *
     * @extends Walker_Nav_Menu
     */
    class Ninico_Navwalker_Class extends Walker_Nav_Menu {
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'edit_theme_options' ) ) {
                ...
                $fallback_output .= '>';
                $fallback_output .= '<li><a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr__( 'Home', 'ninico' ) . '">' . esc_html__( 'Home', 'ninico' ) . '</a></li>';
                $fallback_output .= '</ul>';
                if ( $container ) {
                    $fallback_output .= '</' . esc_attr( $container ) . '>';
                }
