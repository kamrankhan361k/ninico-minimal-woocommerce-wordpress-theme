						...
						<?php
							echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
								...
								sprintf(
									...
									esc_attr__( 'Remove this item', 'ninico' ),
									esc_attr( $product_id ),
...
<?php else : ?>
   ...
   <div class="cartmini__empty text-center">
      <p class="woocommerce-mini-cart__empty-message">
      	<?php esc_html_e( 'No products in the cart.', 'ninico' );?>
      </p>	
      <a href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>" class="tp-btn tp-color-btn w-100 banner-animation"><?php esc_html_e( 'Go to Shop', 'ninico' );?></a>
   </div>
