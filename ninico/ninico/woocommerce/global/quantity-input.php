...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'ninico' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'ninico' );
	?>
	<div class="tpproduct-details__quantity quantity">
		<!-- <div class="quantity tp-product-quantity mt-10 mb-10"> -->
			...
			<input
				...
				title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'ninico' ); ?>"
				size="4"
