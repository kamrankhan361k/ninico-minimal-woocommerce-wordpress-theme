...
<form class="cart grouped_form tp-single-cart-form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
	...
	<?php if ( $quantites_required && $show_add_to_cart_button ) : ?>
		...
		<div class="tpproduct-details__cart mr-5 d-inline-block mt-10 mb-10">
			<button type="submit" class="tp-btn single_add_to_cart_button button alt"><i class="fal fa-shopping-cart"></i><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
		</div>
