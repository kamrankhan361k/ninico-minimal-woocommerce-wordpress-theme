<?php 
	...
	*/
    ...
    $ninico_header_top_right_text = get_theme_mod( 'ninico_header_top_right_text', __('Header Right Text Here.', 'ninico') );
         ...
         <div class="row">
               ...
               <div class="col-xl-5 d-none d-xl-block">
                  <div class="headertoplag d-flex align-items-center justify-content-end">
                     ...
                     <?php if(!empty($ninico_header_top_right_text)) : ?>
                     <div class="headertoplag__lang">
                           <?php echo ninico_kses($ninico_header_top_right_text); ?>
                     </div>
                     <?php endif; ?>
                ...
                <div class="col-xl-2 col-lg-3">
                    <div class="cat-menu__category p-relative">
                        <a data-bs-toggle="collapse" href="#collapsecategory" role="button" aria-expanded="false"
                            aria-controls="collapsecategory"><i class="fal fa-bars"></i><?php echo ninico_kses($ninico_header_pcat_title); ?></a>
